void edge_finder()
{
float v_pos_r6[5591],mean_r6[5591],rms_r6[5591],mp_langau_r6[5591],gsigma_langau_r6[5591],rms_mean_r6[5591],res_langau_r6[5591],weight_r6[5591],scale_r6[5591];
float v_pos_r5ff[5591],mean_r5ff[5591],rms_r5ff[5591],mp_langau_r5ff[5591],gsigma_langau_r5ff[5591],rms_mean_r5ff[5591],res_langau_r5ff[5591],weight_r5ff[5591],scale_r5ff[5591];
float v_pos_r4[5591],mean_r4[5591],rms_r4[5591],mp_langau_r4[5591],gsigma_langau_r4[5591],rms_mean_r4[5591],res_langau_r4[5591],weight_r4[5591],scale_r4[5591];
float v_pos_r3[5591],mean_r3[5591],rms_r3[5591],mp_langau_r3[5591],gsigma_langau_r3[5591],rms_mean_r3[5591],res_langau_r3[5591],weight_r3[5591],scale_r3[5591];
float v_pos_r2[5591],mean_r2[5591],rms_r2[5591],mp_langau_r2[5591],gsigma_langau_r2[5591],rms_mean_r2[5591],res_langau_r2[5591],weight_r2[5591],scale_r2[5591];
float v_pos_r1[5591],mean_r1[5591],rms_r1[5591],mp_langau_r1[5591],gsigma_langau_r1[5591],rms_mean_r1[5591],res_langau_r1[5591],weight_r1[5591],scale_r1[5591];
...
infile_r6.open("high-prec-files/full-scan-10k/r6_w.txt");
infile_r5ff.open("high-prec-files/full-scan-10k/r5_w.txt");
infile_r4.open("high-prec-files/full-scan-10k/r4_w.txt");
infile_r3.open("high-prec-files/full-scan-10k/r3_w.txt");
infile_r2.open("high-prec-files/full-scan-10k/r2_w.txt");
infile_r1.open("high-prec-files/full-scan-10k/r1_w.txt");
/*infile_r6.open("high-prec-files/full-scan-10k/r6.txt");
infile_r5ff.open("high-prec-files/full-scan-10k/r5.txt");
infile_r4.open("high-prec-files/full-scan-10k/r4.txt");
infile_r3.open("high-prec-files/full-scan-10k/r3.txt");
infile_r2.open("high-prec-files/full-scan-10k/r2.txt");
infile_r1.open("high-prec-files/full-scan-10k/r1.txt");*/
...
Scale->SetTitle("Ratio of signal size in DS vs. US detectors");
Scale->GetXaxis()->SetLimits(259,281);
Scale->GetYaxis()->SetRangeUser(0,1.5);
Scale->Draw("A");
c6->SetGridx();
c6->SetGridy();

TF1 *f1 = new TF1("f1","(TMath::Erf((x-[0])/[1]) + 1)/2",260,280);
...
legend->SetHeader("Tile Edge Search","C"); // option "C" allows to center the header
//legend->AddEntry(Scale_r1,"R2/R1","lep");
//legend->AddEntry(Scale_r2,"R3/R2","lep");
//legend->AddEntry(Scale_r3,"R4/R3","lep");
legend->AddEntry(Scale_r4,"R5/R4","lep");
//legend->AddEntry(Scale_r5ff,"R6/R5","lep");
...
c1->Print("plots/high-prec/total-scan-10k/mean_PE_yield.root");
c2->Print("plots/high-prec/total-scan-10k/langau_PE_yield.root");
c3->Print("plots/high-prec/total-scan-10k/rms_mean.root");
c4->Print("plots/high-prec/total-scan-10k/langau_res.root");
c5->Print("plots/high-prec/total-scan-10k/weight.root");
c6->Print("plots/high-prec/total-scan-10k/scale_R5_R4.root");
/*c1->Print("plots/high-prec/total-scan-10k/mean_PE_yield_noWeight_R6.root");
c2->Print("plots/high-prec/total-scan-10k/langau_PE_yield_noWeight_R6.root");
c3->Print("plots/high-prec/total-scan-10k/rms_mean_noWeight.root");
c4->Print("plots/high-prec/total-scan-10k/langau_res_noWeight.root");
c5->Print("plots/high-prec/total-scan-10k/weight_noWeight.root");
c6->Print("plots/high-prec/total-scan-10k/scale_noWeight.root");*/
